...
if(Input::exists('post')) {
    ...
    foreach ($m as $key => $value) {
        ...
        array_push($metrics,$value->data()->metric);
    }
                ...
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to add indicator to the database.</p>
                        ...
                        <form  role="form" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    foreach ($indicators as $index => $value) {
                                        ...
                                        $selected = $form->data()->indicator_id === (''.$indicator->id)? 'selected' : '' ;
                            ...
                            <input type="hidden" name="id" value="<?php echo $form->data()->id; ?>">
